...
This is to simulate a change made on a robot: robot_speed = 59 # m/s.
This speed cannot be more than 100 ms/s.
"""

def main():
    print("Hello World!")

    name = "KThex" # TODO: Insert your name between the double quotes
